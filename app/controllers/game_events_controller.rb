class GameEventsController < ApplicationController
  ...
  def destroy
    @game_event.destroy
    respond_to do |format|
      format.html { redirect_to game_events_url, notice: 'Game event was successfully destroyed.' }
  ...
  private
    ...
    def game_event_params
      params.require(:game_event).permit(:title, :description, :game_system, :start_date_time, :hours_duration, :number_of_players, :approved, :scheduled, :accepting_players, :gm_id)
    end
end
